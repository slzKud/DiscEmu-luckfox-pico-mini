...
ifeq (1,$(SCREEN_ROTATE))
CXXFLAGS+= -DSCREEN_ROTATE
CFLAGS+= -DSCREEN_ROTATE
endif
...
ifeq (1,$(DEADFATTY_KEYPAD_INPUT))
CXXFLAGS+= -DDEADFATTY_KEYPAD_INPUT
CFLAGS+= -DDEADFATTY_KEYPAD_INPUT
endif
